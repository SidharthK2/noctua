...
export const watcherAbi = parseAbi([
  "event Filled(bytes32 indexed quoteHash, address indexed maker, address indexed borrower, (address maker, address taker, address loanAsset, address collateralAsset, uint256 principal, uint256 repayment, uint256 collateral, uint256 maturity, uint256 expiry, uint256 nonce) quote)",
